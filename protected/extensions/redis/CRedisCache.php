	...
	public function getRedis()
	{
		if($this->_cache!==null)
            ...
            if(!extension_loaded('Redis'))
            	throw new CException(Yii::t('yii',"Redis requires PHP {extension} extension to be loaded.You can dowload it from <a href='https://github.com/nicolasff/phpredis' target='_blank'>github</a> , and install it as the php extension",
            			array('{extension}'=>'Redis')));
			$this->_cache = new Redis();
			$this->_cache->connect($this->servers[0]["server"],$this->servers[0]["port"]);
			return $this->_cache;
        }
	}
